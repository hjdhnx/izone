...
PGSQL_HOST = os.getenv('IZONE_PGSQL_HOST', '127.0.0.1')
MYSQL_NAME = os.getenv('IZONE_MYSQL_NAME', 'izone')
PGSQL_NAME = os.getenv('IZONE_PGSQL_NAME', 'izone')
MYSQL_USER = os.getenv('IZONE_MYSQL_USER', 'root')
PGSQL_USER = os.getenv('IZONE_PGSQL_USER', 'postgres')
MYSQL_PASSWORD = os.getenv('IZONE_MYSQL_PASSWORD', 'hjd124579')
PGSQL_PASSWORD = os.getenv('IZONE_PGSQL_PASSWORD', 'hjd124579')
...
# 个性化设置，非必要信息
# 个人 Github 地址
MY_GITHUB = os.getenv('IZONE_GITHUB', 'https://github.com/hjdhnx')
# 工信部备案信息
